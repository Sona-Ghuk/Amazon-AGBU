...
validUser = User("sona.ghukasyan@gmail.com", "hasiko07")
userWithInvalidUserName = User("sona@gmail.com", "hasiko07")
userWithInvalidPassword = User("sona.ghukasyan@gmail.com", "fendi123")
